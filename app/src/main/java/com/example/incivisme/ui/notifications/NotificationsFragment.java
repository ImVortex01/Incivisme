...
import com.example.incivisme.API.ValenBisiAPI;
...
public class NotificationsFragment extends Fragment {
    ...
    private final String imagen = "https://firebasestorage.googleapis.com/v0/b/incivisme-2fe4b.appspot.com/o/publicaciones%2F";
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                m.setOnMarkerClickListener(new Marker.OnMarkerClickListener(){
                    ...
                    public boolean onMarkerClick(Marker marker, MapView mapView) {
                        String imagen = "https://firebasestorage.googleapis.com/v0/b/incivisme-2fe4b.appspot.com/o/publicaciones%2F";
